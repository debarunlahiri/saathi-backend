...
final class PartnerSelectionSupport {
            ...
            partner ->
                taskLatitude == null
                    ...
                    || candidate(taskLatitude.doubleValue(), taskLongitude.doubleValue(), partner)
                        ...
                        .orElse(false))
        .max(
            Comparator.comparingDouble(PartnerSelectionSupport::rating)
  ...
  private static Optional<Candidate> candidate(
    ...
    double distanceKm =
        distanceKm(taskLatitude, taskLongitude, partnerLatitude.get(), partnerLongitude.get());
  ...
  private static double distanceOrMax(Task task, Map<String, Object> partner) {
    ...
    return candidate(
            task.getPickupLatitude().doubleValue(),
            task.getPickupLongitude().doubleValue(),
            partner)
