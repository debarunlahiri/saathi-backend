...
public class AuthController {
    ...
    public ApiResponse<AuthResponse> registerCustomer(@Valid @RequestBody RegisterRequest request) {
        return ApiResponse.success("Customer registered successfully", authService.register(request, UserRole.CUSTOMER));
    }

    @PostMapping("/partner/register")
    public ApiResponse<AuthResponse> registerPartner(@Valid @RequestBody RegisterRequest request) {
        return ApiResponse.success("Partner registered successfully", authService.register(request, UserRole.PARTNER));
    }
