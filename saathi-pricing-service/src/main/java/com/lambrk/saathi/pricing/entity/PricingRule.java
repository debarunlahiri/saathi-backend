...
public class PricingRule {
    ...
    public BigDecimal getIncludedDistanceKm() { return includedDistanceKm; }
    public void setIncludedDistanceKm(BigDecimal includedDistanceKm) { this.includedDistanceKm = includedDistanceKm; }
    ...
    public int getIncludedWaitingMinutes() { return includedWaitingMinutes; }
    public void setIncludedWaitingMinutes(int includedWaitingMinutes) { this.includedWaitingMinutes = includedWaitingMinutes; }
    public int getPerWaitingUnitMinutes() { return perWaitingUnitMinutes; }
    public void setPerWaitingUnitMinutes(int perWaitingUnitMinutes) { this.perWaitingUnitMinutes = perWaitingUnitMinutes; }
    public BigDecimal getPerWaitingUnitCharge() { return perWaitingUnitCharge; }
    public void setPerWaitingUnitCharge(BigDecimal perWaitingUnitCharge) { this.perWaitingUnitCharge = perWaitingUnitCharge; }
    public BigDecimal getUrgentCharge() { return urgentCharge; }
    public void setUrgentCharge(BigDecimal urgentCharge) { this.urgentCharge = urgentCharge; }
