...
public class AdminDashboardController {
    ...
    @GetMapping("/dashboard") public ApiResponse<DashboardResponse> dashboard() { return ApiResponse.success("Dashboard fetched successfully", service.dashboard()); }
    @GetMapping("/reports") public ApiResponse<DashboardResponse> reports() { return ApiResponse.success("Report generated successfully", service.dashboard()); }
}
